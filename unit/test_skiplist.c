...
bool test_insert(void) {
	...
	mu_assert_eq ((int)(intptr_t)n, (int)NULL, "150 shouldn't be in the list");
	n = r_skiplist_find (list, (void *)(intptr_t)(-10));
	mu_assert_eq ((int)(intptr_t)n, (int)NULL, "-10 shouldn't be in the list");
